...

{
  ...
  "detailedReasoning": {
    "overview": "<2-3 paragraphs explaining your overall thinking about this pitch after reviewing ALL materials, what stood out, and how the additional docs changed your perspective>",
    "documentComprehension": "<detailed explanation of what you understood from BOTH the pitch deck AND additional documents - key claims, data points, team info, product details, market assertions, new information revealed>",
    "scoringRationale": {
    ...
    "finalThoughts": "<your concluding analysis and reasoning for the overall recommendation after seeing all materials>"
  }
}
